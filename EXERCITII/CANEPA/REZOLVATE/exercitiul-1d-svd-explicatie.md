...
$A^TA$ e o matrice $3\times3$ cu liniile $(13,12,2)$, $(12,13,-2)$, $(2,-2,8)$.
...
$\Sigma$ are **forma lui $A$** ($2\times3$, nu $3\times3$ — atenție, e cea mai frecventă capcană la SVD nepătratic): liniile $(5,0,0)$ și $(0,3,0)$.

## Mișcarea 3 — matricea U (doar pentru σ nenule)

$$u_i = \frac1{\sigma_i}Av_i$$

$A$ aplicată pe $v_1$ (matricea $A$ înmulțită cu vectorul-coloană $v_1$) dă $(5/\sqrt2,\ 5/\sqrt2)^T$, deci:

$$u_1=\frac15Av_1=(1/\sqrt2,\ 1/\sqrt2)^T$$

Similar, $A$ aplicată pe $v_2$ dă $(-3/\sqrt2,\ 3/\sqrt2)^T$, deci:

$$u_2=\frac13Av_2=(-1/\sqrt2,\ 1/\sqrt2)^T$$
...
$U$ are liniile $(1/\sqrt2,\ -1/\sqrt2)$ și $(1/\sqrt2,\ 1/\sqrt2)$.

## Rezultat final

$$A = U\Sigma V^T$$

- $U$: liniile $(1/\sqrt2,\ -1/\sqrt2)$ și $(1/\sqrt2,\ 1/\sqrt2)$
- $\Sigma$: liniile $(5,0,0)$ și $(0,3,0)$
- $V$: liniile $(1/\sqrt2,\ -1/(3\sqrt2),\ -2/3)$, $(1/\sqrt2,\ 1/(3\sqrt2),\ 2/3)$, $(0,\ -4/(3\sqrt2),\ 1/3)$
